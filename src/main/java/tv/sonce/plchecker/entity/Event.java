...
public class Event {
    ...
    public Event(int NumberOfEvent, String date, String time, String duration, String tcIn, String tcOut, String assetId, String name, String format, String status){
        ...
        this.name = name.trim();
        this.format = Arrays.stream(format.split(",")).map(String::trim).toArray(String[]::new);
        this.status = status;
